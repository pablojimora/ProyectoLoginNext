...
// }
    ...
    // el useState sirve para controlar el estado de una variable
        ...
        <>
            ...
            {/* con este div realizo la creacion de registros conectado al post  */}
                <div className='inputs'>
                    ...
                    <input type='number' onChange={(e)=>{setvalueInput(parseFloat(e.target.value))}} />
                    <input onChange={(e)=>{setimgInput(e.target.value)}} />
