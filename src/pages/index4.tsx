...
export default function App() {
  ...
  class Estudiante extends Coder {
    ...
    constructor(name:string, age:number, email:string, course:string, university:string){
    ...
    showCursor(){
      return`El coder y estudiante ${this.name}, esta matriculado en ${this.course} en la universidad ${this.university}`
    }
  }

  const estudiante1 = new Estudiante("Carolina", 24, "pablo@correo.com", "Matematicas", "ITM")

  console.log(estudiante1.showCursor())
